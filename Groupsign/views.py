...
from .open_manager import Open_Manager
    ...
    if request.user.is_opening_manager:
        if request.method == 'POST':
            ...
            try:
                ...
                if openuser is None:
                    messages.error(request, ' No User Is Found ! Please Check Validity Of Message.', extra_tags=True)
        ...
        if request.method == 'POST':
            ...
            if revocation_Ai is None:
                ...
                if revocation_request_Ai is None:
                    ...
                    revocation_request.User = request.POST['User']
